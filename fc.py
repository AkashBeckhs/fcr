...
def checkImage(img1,img2):
    ...
    biden_encoding = face_recognition.face_encodings(known_image,num_jitters=20)[0]
    unknown_encoding = face_recognition.face_encodings(unknown_image,num_jitters=20)[0]
